...
/*       Role r1 = new Role(0l,"ROLE_ADMIN");
        ...
        User u1 = new User(0L, "jkowalski", "admin", "jkowalski@survey.pl","999888777",18, new HashSet<Role>(Arrays.asList(r1)),true);
        User u2 = new User(0L, "anowak", "admin", "anowak@survey.pl","999888777",17, new HashSet<Role>(Arrays.asList(r2)),true);
        User u3 = new User(0L, "abodzio", "admin", "abodzio@survey.pl","999888777",20, new HashSet<Role>(Arrays.asList(r1)),true);
